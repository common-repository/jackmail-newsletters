			...
			<div ng-show="$root.settings.is_authenticated" class="jackmail_settings_container jackmail_settings_plr_15">
				...
				<div>
					...
					<p ng-show="s.formula.nb_credits !== ''">
						<span class="jackmail_m_r_15 jackmail_text_red">
					...
					<p ng-show="s.formula.product_key !== '' || s.formula.subscription_type !== ''">
						...
						<span ng-show="s.formula.subscription_type === 'FREE'">
							<span ng-show="s.formula.days_until_expiration >= 0" class="jackmail_text_red">
								<?php _e( 'Your trial period is still valid', 'jackmail-newsletters' ) ?>
								<span class="jackmail_bold">{{s.formula.days_until_expiration}}</span>
								<span ng-show="s.formula.days_until_expiration > 1"><?php _e( 'days.', 'jackmail-newsletters' ) ?></span>
								<span ng-show="s.formula.days_until_expiration <= 1"><?php _e( 'day.', 'jackmail-newsletters' ) ?></span>
							</span>
							<a href="<?php esc_attr_e( 'https://www.jackmail.com/pricing?utm_source=pluginjackmail&utm_medium=banner&utm_campaign=changejackmailaccount', 'jackmail-newsletters' ) ?>" target="_blank" class="jackmail_button">
								<?php _e( 'I choose my subscription', 'jackmail-newsletters' ) ?>
							</a>
						</span>
					</p>
					<p>
